...
class Security {
    constructor(settings) {
         ...
         */
        this.generateToken = (data, secret = this[_secret], expiration = new Date().getTime() + (1000 * 60 * 30)) => {
         ...
         */
        this.refreshToken = (token, secret = this[_secret], expiration = new Date().getTime() + (1000 * 60 * 30)) => {

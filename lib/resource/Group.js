...
class Group extends baseResource_1.baseResource {
    constructor(connector, Model, settings) {
         ...
         */
        this.addUserToGroup = (options) => __awaiter(this, void 0, void 0, function* () {
     ...
     To prevent this, use this parameter to specify a different group to transfer the restrictions (comments and worklogs only) to.
         ...
         * @return {Promise.<any>} result of api call
         */
        this.getUsersFromGroup = (options) => __awaiter(this, void 0, void 0, function* () {
         ...
         * @return {Promise.<any>} result of api call
         */
        this.removeUserFromGroup = (options) => __awaiter(this, void 0, void 0, function* () {

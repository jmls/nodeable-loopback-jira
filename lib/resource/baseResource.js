...
class baseResource {
    constructor(connector, Model, settings) {
         ...
         */
        this.makeRequest = (method, verb, url, options = {}) => __awaiter(this, void 0, void 0, function* () {
...
baseResource.loadDefinition = (modelName, customFolder) => {
    ...
    let custom = _.merge({}, baseResource.loadCustom(`./definition/${modelName}`), customFolder

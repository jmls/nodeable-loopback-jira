...
class Reindex extends baseResource_1.baseResource {
    constructor(connector, Model, settings) {
         ...
         */
        this.getReindexInfo = (options) => __awaiter(this, void 0, void 0, function* () {
         ...
         * @return {Promise.<any>} result of api call
         */
        this.getReindexProgress = (options) => __awaiter(this, void 0, void 0, function* () {
         ...
         * @return {Promise.<any>} result of api call
         */
        this.reindex = (options) => __awaiter(this, void 0, void 0, function* () {
         ...
         * @return {Promise.<any>} result of api call
         */
        this.reindexIssues = (options) => __awaiter(this, void 0, void 0, function* () {

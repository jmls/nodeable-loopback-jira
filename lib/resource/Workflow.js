...
class Workflow extends baseResource_1.baseResource {
    constructor(connector, Model, settings) {
         ...
         */
        this.createProperty = (options) => __awaiter(this, void 0, void 0, function* () {
         ...
         * @return {Promise.<any>} result of api call
         */
        this.getProperties = (options) => __awaiter(this, void 0, void 0, function* () {
         ...
         * @return {Promise.<any>} result of api call
         */
        this.updateProperty = (options) => __awaiter(this, void 0, void 0, function* () {

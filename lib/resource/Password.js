...
class Password extends baseResource_1.baseResource {
    constructor(connector, Model, settings) {
         ...
         */
        this.getPasswordPolicy = (options) => __awaiter(this, void 0, void 0, function* () {
         ...
         * @return {Promise.<any>} result of api call
         */
        this.policyCheckCreateUser = (options) => __awaiter(this, void 0, void 0, function* () {
         ...
         * @return {Promise.<any>} result of api call
         */
        this.policyCheckUpdateUser = (options) => __awaiter(this, void 0, void 0, function* () {
